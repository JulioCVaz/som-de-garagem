...
var APEv2Parser = /** @class */ (function (_super) {
    __extends(APEv2Parser, _super);
    function APEv2Parser() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type = "APEv2"; // ToDo: versionIndex should be made dynamic, APE may also contain ID3
        _this.ape = {};
        return _this;
    }
    /**
    ...
    APEv2Parser.parseFooter = function (metadata, tokenizer, options) {
    ...
    // ToDo: public ???
    APEv2Parser.parseTags = function (metadata, footer, buffer, includeCovers) {
        var offset = 0;
    ...
    APEv2Parser.prototype.parse = function () {
        var _this = this;
        return this.tokenizer.readToken(Structure.DescriptorParser)
            ...
            return _this.tokenizer.readToken(new Token.IgnoreType(header.forwardBytes)).then(function () {
                return APEv2Parser.parseFooter(_this.metadata, _this.tokenizer, _this.options);
            });
        });
    };
    ...
    APEv2Parser.prototype.parseHeader = function () {
        ...
        return this.tokenizer.readToken(Structure.Header).then(function (header) {
            ...
            _this.metadata.setFormat('dataformat', "Monkey's Audio");
            _this.metadata.setFormat('bitsPerSample', header.bitsPerSample);
            _this.metadata.setFormat('sampleRate', header.sampleRate);
            _this.metadata.setFormat('numberOfChannels', header.channel);
            _this.metadata.setFormat('duration', APEv2Parser.calculateDuration(header));
            return {
